    ...
    <>
      <div className="sm:m-2 md:5 mb-10 z-10">
        ...
        <div className="text-center flex flex-col flex-wrap">
          ...
          <div id="emailSent" class="bg-palegreen border-t-4 invisible  border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
            <div class="flex">
              <div class="py-1"><svg class="fill-current h-5 w-7 text-teal-500 mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M20.285 2l-11.285 11.567-5.286-5.011-3.714 3.716 9 8.728 15-15.285z"/></svg></div>
              <div>
          ...
          <div id="somethingWrong" class="bg-red-100 hidden border-t-4 border-red-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
            <div class="flex">
